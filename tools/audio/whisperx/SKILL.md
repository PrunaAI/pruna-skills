...
Transcribes the **rendered song** with **word-level timestamps**. Primary use: [ai-music-video](../../../guides/workflows/verticals/music-video/SKILL.md) cut alignment after `music-2.5`.
...
```bash
python3 guides/workflows/_shared/scripts/whisperx_to_srt.py \
  --transcript output/my-mv/whisperx_transcript.json
```
