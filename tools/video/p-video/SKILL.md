...
For **narration or music** on this single clip, see [audio-post-production.md](../../../references/audio/audio-post-production.md) — Gemini TTS, Stable Audio beds, or upload audio for audio-conditioned mode.
