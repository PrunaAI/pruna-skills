...
**No prompt upsampling** on this model — keep prompts concrete per [generation-diversity](../../../references/shared/generation-diversity.md#text--typography-by-model). For dense readable typography, use [p-image-ideogram](../p-image-ideogram/SKILL.md).
