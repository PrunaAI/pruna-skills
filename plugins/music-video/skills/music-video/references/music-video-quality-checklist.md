...
- [ ] No readable UI text, laptops screens, or collage trigger words — see [visual-variety-bible.md](https://github.com/PrunaAI/pruna-skills/tree/main/shared/visual-variety-bible.md#prompt-patterns) blocked still phrases where applicable
