...
|----------|-------------------|
| [p-image-try-on](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/p-image-try-on/skills/p-image-try-on/SKILL.md) | Editorial plates + complex garment refs; preservation checklist; diversity across playground set |
...
- [p-video-animate-quality-checklist.md](https://github.com/PrunaAI/pruna-skills/tree/main/workflows/core/p-video-animate-quality-checklist/SKILL.md)
