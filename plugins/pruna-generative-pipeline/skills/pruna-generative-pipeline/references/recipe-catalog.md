...
Full intake and steps for each recipe in [pruna-generative-pipeline](../SKILL.md). **Confirm plan before any `POST /v1/predictions`.** Staged gates: [staged-generation-gate.md](https://github.com/PrunaAI/pruna-skills/tree/main/shared/staged-generation-gate.md).
...
- Hub skill: [pruna-generative-pipeline/SKILL.md](../SKILL.md)
