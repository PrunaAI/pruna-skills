...
Related: [scene-anchor-triple.md](./scene-anchor-triple.md) (pair + audio) · [p-video](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/p-video/skills/p-video/SKILL.md) · [p-image](../../p-image/SKILL.md) · [p-image-edit](../SKILL.md)
