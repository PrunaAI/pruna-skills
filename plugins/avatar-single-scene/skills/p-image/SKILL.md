...
- Scripted workflows (intake first): [avatar-single-scene](../avatar-single-scene/SKILL.md), [avatar-multi-scene](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/avatar-multi-scene/skills/avatar-multi-scene/SKILL.md)
