...
See also: [parallel-execution.md](https://github.com/PrunaAI/pruna-skills/tree/main/workflows/core/parallel-execution/SKILL.md) Phase 0, [generation-quality-checklists.md](./generation-quality-checklists.md), [workflow-feedback-gates.md](https://github.com/PrunaAI/pruna-skills/tree/main/workflows/workflow-feedback-gates.md) (per-skill index), [requesting-generation-feedback](../../requesting-generation-feedback/SKILL.md) (red flags before paid generation).
