...
Record in the plan: `ritual_seed`, `cast` / `character_sheet`, approved **`hero_still`** URL, and `continuity: same_singer | recasts_ok`. Full cast-ledger patterns: [avatar-multi-scene](../avatar-multi-scene/SKILL.md) **Character sheet** and **Source portrait / hero**.
