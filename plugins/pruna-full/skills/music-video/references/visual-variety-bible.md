...
|----------|-------------------|
| [p-image-try-on](../../p-image-try-on/SKILL.md) | Editorial plates + complex garment refs; preservation checklist; diversity across playground set |
...
| [pruna-generative-pipeline](../../pruna-generative-pipeline/SKILL.md) | Intake must capture variety plan before recipe execution |
