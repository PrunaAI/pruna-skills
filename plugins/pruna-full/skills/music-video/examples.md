...
See [`music_video_plan.json`](https://github.com/PrunaAI/pruna-skills/tree/main/output/verticals/music-video/purple-pruna-rap/music_video_plan.json) for lyrics, `ritual_seed`, and segment prompts.
