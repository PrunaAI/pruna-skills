...
Same discipline as [p-image](../p-image/SKILL.md): documentary portrait language, diverse cast, avatar-ready mouth visibility, try-on-ready body coverage. Full matrix: [realistic-persona-showcase.md](./references/realistic-persona-showcase.md).
...
- Animate still: [p-video](../p-video/SKILL.md) or [p-video-avatar](../p-video-avatar/SKILL.md)
- Full pipeline: [pruna-generative-pipeline](../pruna-generative-pipeline/SKILL.md)
