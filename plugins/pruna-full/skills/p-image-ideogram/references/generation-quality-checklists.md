...
| `p-image-ideogram` | [`p-image-quality-checklist.md`](https://github.com/PrunaAI/pruna-skills/tree/main/image/p-image-quality-checklist.md) · persona bar: [`realistic-persona-showcase.md`](./realistic-persona-showcase.md) | [`p-image-ideogram`](../SKILL.md), [`pruna-generative-pipeline`](../../pruna-generative-pipeline/SKILL.md) |
