...
If the request exceeds one clip, **stop** and recommend: [image-to-video](../image-to-video/SKILL.md) (one narrated beat), [visual-transition-reel](../visual-transition-reel/SKILL.md) (multi-scene visual), or [narrated-multi-scene](../narrated-multi-scene/SKILL.md) (multi-scene + VO).
