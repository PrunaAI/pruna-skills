...
**Visual-only transitions (no VO):** use the [scene anchor pair](https://github.com/PrunaAI/pruna-skills/tree/main/workflows/core/scene-anchor-pair/SKILL.md) — `duration` instead of `audio`; see [visual-transition-reel](../../visual-transition-reel/SKILL.md).
...
**Over 20s?** Shorten scene copy → tighten TTS pace in `style_prompt` → split into two scene rows (each with its own triple). See [narrated-multi-scene](../../narrated-multi-scene/SKILL.md) duration gate.
...
| Need | Tool | Skill |
|------|------|-------|
| Cinematic clip with model-generated sound | `p-video` (`save_audio`, optional uploaded `audio`) | [p-video](../../p-video/SKILL.md) |
| Lip-sync / duration locked to VO | Upload audio → `p-video` with `audio` | [p-video](../../p-video/SKILL.md) |
...
| Light instrumental under dialogue | [Stable Audio 2.5](https://replicate.com/stability-ai/stable-audio-2.5) | [stable-audio-2.5](../../stable-audio-2.5/SKILL.md) |
| Full song with sung vocals | [Music 2.5](https://replicate.com/minimax/music-2.5) | [music-2.5](../../music-2.5/SKILL.md) |
| Speaking on-camera character | `p-video-avatar` | [p-video-avatar](../../p-video-avatar/SKILL.md) |
...
| **Music video** | Music 2.5 full song | — | [music-video](../../music-video/SKILL.md) |
...
| **Music / bed** | None, instrumental bed only, or full song ([music-2.5](../../music-2.5/SKILL.md))? |
...
- Extreme camera motion and complex multi-scene stories are weaker than **frame-anchored chaining** + per-scene prompts — see [p-video](../../p-video/SKILL.md) **First / last frame chaining**.
...
- [narrated-multi-scene](../../narrated-multi-scene/SKILL.md)
- [pruna-generative-pipeline](../../pruna-generative-pipeline/SKILL.md)
