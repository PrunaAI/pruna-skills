...
Related: [scene-anchor-pair.md](https://github.com/PrunaAI/pruna-skills/tree/main/workflows/core/scene-anchor-pair/SKILL.md) (visual-only) · [audio-post-production.md](./audio-post-production.md) · [p-video](../../p-video/SKILL.md)
...
1. [Gemini 3.1 Flash TTS](../SKILL.md) (or [Music 2.5](../../music-2.5/SKILL.md) slice for music videos)
2. Download MP3/WAV
