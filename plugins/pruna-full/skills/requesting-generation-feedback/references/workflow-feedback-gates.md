...
**Discipline skill (read before any paid generation):** [requesting-generation-feedback](../SKILL.md) — red flags, pause workflow, common mistakes when about to call `POST /v1/predictions`, mix final audio, or skip user review.
...
| [pruna-generative-pipeline](../../pruna-generative-pipeline/SKILL.md) | recipe-specific | — | routes to rows above |
