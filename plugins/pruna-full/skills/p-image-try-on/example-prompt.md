...
Run the slop gate on the person plate before step 2. Run [p-image-try-on-quality-checklist.md](./references/p-image-try-on-quality-checklist.md) on the output.
