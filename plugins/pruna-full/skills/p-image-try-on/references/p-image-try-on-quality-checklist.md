...
See [realistic-persona-showcase.md](https://github.com/PrunaAI/pruna-skills/tree/main/shared/realistic-persona-showcase.md#preservation-checklist-the-models-differentiator). Quality bar: [p-image-try-on-quality-checklist.md](./p-image-try-on-quality-checklist.md).

## Garment fit and identity

- Each requested garment appears on the person (correct category — see supported types in [p-image-try-on SKILL.md](../SKILL.md#garment-categories)).
