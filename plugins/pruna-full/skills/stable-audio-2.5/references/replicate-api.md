...
Used by external tool skills (e.g. [stable-audio-2.5](../SKILL.md), [gemini-3.1-flash-tts](../../gemini-3.1-flash-tts/SKILL.md)).
...
Workflow: [music-video](../../music-video/SKILL.md) · tool skill: [music-2.5](../../music-2.5/SKILL.md)
...
Use for high-quality fast photoreal stills. Fastest drafts: [p-image](../../p-image/SKILL.md) (Pruna P-API). Tool skill: [p-image-ideogram](../../p-image-ideogram/SKILL.md)
