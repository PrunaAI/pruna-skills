...
1. [Gemini 3.1 Flash TTS](../../gemini-3.1-flash-tts/SKILL.md) per scene (or [Music 2.5](../../music-2.5/SKILL.md) slice for music videos)
2. Download MP3/WAV
...
- [narrated-multi-scene](../../narrated-multi-scene/SKILL.md) — primary narrated workflow
- [image-to-video](../../image-to-video/SKILL.md) — one beat
