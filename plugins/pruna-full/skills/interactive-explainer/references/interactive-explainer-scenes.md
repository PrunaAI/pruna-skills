...
Related: [scene-anchor-triple.md](https://github.com/PrunaAI/pruna-skills/tree/main/video/scene-anchor-triple.md) (narrator beats) · [avatar-multi-scene](../../avatar-multi-scene/SKILL.md) (character beats) · [interactive-explainer](../SKILL.md)
...
- [narrated-multi-scene](../../narrated-multi-scene/SKILL.md) — narrator-only fallback
- [avatar-multi-scene](../../avatar-multi-scene/SKILL.md) — character-only pieces
