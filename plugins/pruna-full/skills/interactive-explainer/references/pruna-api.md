...
**Agent discipline:** [generation-diversity.md](https://github.com/PrunaAI/pruna-skills/tree/main/workflows/core/generation-diversity/SKILL.md) before every `POST /v1/predictions`.
