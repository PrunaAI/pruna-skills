...
| Route | When | Chain |
|-------|------|-------|
| **image** | Still only, fastest draft | [p-image](../../../../tools/image/p-image/SKILL.md) |
| **image-hq** | Still only, high-quality photoreal | [p-image-ideogram](../../../../tools/image/p-image-ideogram/SKILL.md) |
| **i2v** | Motion from a still | `p-image` or `p-image-ideogram` → [p-video](../../../../tools/video/p-video/SKILL.md) |
| **avatar** | Talking head | `p-image` or `p-image-ideogram` → [p-video-avatar](../../../../tools/video/p-video-avatar/SKILL.md) |
...
- Multi-scene work: use dedicated workflow skills — narrated films use [scene-anchor-triple.md](https://github.com/PrunaAI/pruna-skills/tree/main/references/shared/scene-anchor-triple.md) ([narrated-multi-scene](../narrated-multi-scene/SKILL.md)).
