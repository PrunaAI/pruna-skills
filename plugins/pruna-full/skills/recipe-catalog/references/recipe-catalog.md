...
Full intake and steps for each recipe in [pruna-generative-pipeline](../../pruna-generative-pipeline/SKILL.md). **Confirm plan before any `POST /v1/predictions`.** Staged gates: [staged-generation-gate.md](https://github.com/PrunaAI/pruna-skills/tree/main/shared/staged-generation-gate.md).
...
**Refs:** [p-image](../../p-image/SKILL.md), [p-image-edit](../../p-image-edit/SKILL.md), [p-image-upscale](../../p-image-upscale/SKILL.md)
...
3. **`p-video`** with `image` + motion `prompt`; add `last_frame_image` for controlled arc. Full intake: [image-to-video](../../image-to-video/SKILL.md).

## Recipe E — Audio-conditioned `p-video` (single anchor)

**Shine:** Duration tracks audio automatically—ideal for VO-first social cuts.

**Intake:** Audio format? Visual story matching beats? Source: upload, [Gemini TTS](../../gemini-3.1-flash-tts/SKILL.md), or [Music 2.5](../../music-2.5/SKILL.md)?
...
1. Build **character sheet** and **scene table** — see [avatar-multi-scene](../../avatar-multi-scene/SKILL.md).
...
4. Hand off to [avatar-single-scene](../../avatar-single-scene/SKILL.md) or [avatar-multi-scene](../../avatar-multi-scene/SKILL.md) for **`p-video-avatar`** batch.
...
1. Use [avatar-multi-scene](../../avatar-multi-scene/SKILL.md) for all-`p-video-avatar` stacks, or mix with [narrated-multi-scene](../../narrated-multi-scene/SKILL.md) B-roll only when the user explicitly wants cutaways.
...
1. Full workflow: [avatar-multi-scene](../../avatar-multi-scene/SKILL.md) — **`animate`** rows, sliders, concat.
...
**Steps:** [music-video](../../music-video/SKILL.md) — lyrics → Music 2.5 → align → stills → `p-video-avatar` / `p-video` → assembly.
...
1. Full workflow: [narrated-multi-scene](../../narrated-multi-scene/SKILL.md) — [scene-anchor-triple.md](https://github.com/PrunaAI/pruna-skills/tree/main/video/scene-anchor-triple.md).
...
**Steps:** [visual-transition-reel](../../visual-transition-reel/SKILL.md) — [scene-anchor-pair.md](https://github.com/PrunaAI/pruna-skills/tree/main/video/scene-anchor-pair.md).
...
**Steps:** [illustrated-story-reel](../../illustrated-story-reel/SKILL.md) — `p-image` hero → `p-image-edit` beats → Gemini TTS per beat **or** Stable Audio / user track → ffmpeg assemble.
...
**Steps:** [p-image-try-on](../../p-image-try-on/SKILL.md) + [realistic-persona-showcase.md](https://github.com/PrunaAI/pruna-skills/tree/main/shared/realistic-persona-showcase.md) + [p-video-avatar](../../p-video-avatar/SKILL.md) — phased gates per [workflow-feedback-gates.md](https://github.com/PrunaAI/pruna-skills/tree/main/workflows/core/workflow-feedback-gates/SKILL.md).
...
| Full SKU creative kit | **B** + [p-image-try-on](../../p-image-try-on/SKILL.md) |
| Episodic mascot channel | **G** + [avatar-multi-scene](../../avatar-multi-scene/SKILL.md) |
...
- Hub skill: [pruna-generative-pipeline/SKILL.md](../../pruna-generative-pipeline/SKILL.md)
- Feedback discipline: [requesting-generation-feedback/SKILL.md](../../requesting-generation-feedback/SKILL.md)
