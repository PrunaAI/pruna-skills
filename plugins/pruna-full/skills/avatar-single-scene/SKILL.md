...
One approved portrait → one **`p-video-avatar`** job. Stills and QA reuse the same patterns as [avatar-multi-scene](../avatar-multi-scene/SKILL.md); use [generation-quality-checklists.md](https://github.com/PrunaAI/pruna-skills/tree/main/references/shared/generation-quality-checklists.md) and that folder’s **`prompt-templates.md`**.
...
Atomic APIs: [p-video-avatar](../../../../tools/video/p-video-avatar/SKILL.md), [p-image](../../../../tools/image/p-image/SKILL.md), [p-image-edit](../../../../tools/image/p-image-edit/SKILL.md), [pruna-api.md](./references/pruna-api.md).

**Photoreal dynamic personas:** [realistic-persona-showcase.md](./references/realistic-persona-showcase.md)

**Staged generation:** [staged-generation-gate.md](./references/staged-generation-gate.md) · [random-seed-ritual.md](./references/random-seed-ritual.md) · [workflow-feedback-gates.md](./references/workflow-feedback-gates.md)
...
| **Ritual seed (SSoT)** | **[Random seed ritual](./references/random-seed-ritual.md)** at hero → log **`ritual_seed`**; derive prompt axes. Identity continuity = approved plate URL. Optional **`api_seed`** only when user locks API reproducibility |
...
3. **Slop gate** — Run the checklist in [generation-quality-checklists.md](https://github.com/PrunaAI/pruna-skills/tree/main/references/shared/generation-quality-checklists.md); fix with image models until pass.
