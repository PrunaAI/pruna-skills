...
See [visual-variety-bible.md](./visual-variety-bible.md#prompt-patterns) for blocked still trigger words.
...
Pull full ladders from [visual-variety-bible.md](./visual-variety-bible.md#lighting-ladder). Minimum for a **5-example playground set**: 3 different `lighting_tag` + 5 different `setting_tag` values.
...
Applies to **every** `visual_style_tag` — not photoreal only. Full stack: [visual-variety-bible.md](./visual-variety-bible.md#dynamic-prompt-stack-eye-catching).
...
Run [p-image-quality-checklist.md](https://github.com/PrunaAI/pruna-skills/tree/main/image/p-image-quality-checklist.md) — persona rows below.
...
More plate examples (including try-on garment tiers): [p-image-try-on SKILL.md](../SKILL.md#production-quality-not-basic-demos).
...
Run [p-video-avatar-quality-checklist.md](https://github.com/PrunaAI/pruna-skills/tree/main/video/p-video-avatar-quality-checklist.md) input section. Reject plates with obscured mouth, extreme profile-only crop, or synthetic mush skin.
...
See camera/motion ladder: [visual-variety-bible.md](./visual-variety-bible.md#camera-angle--movement-ladder).
...
Workflow skills: [avatar-single-scene](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/avatar-single-scene/skills/avatar-single-scene/SKILL.md) · [avatar-multi-scene](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/avatar-multi-scene/skills/avatar-multi-scene/SKILL.md).
...
When stills risk signage or label bleed, use plan defaults — see [p-video-avatar SKILL.md](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/p-video-avatar/skills/p-video-avatar/SKILL.md#negative-prompt-suppress-on-screen-text). Primary fix remains **clean still prompts**; API negative prompt is a safety net.
...
|-------|-------|-----------|
| `p-image` | [p-image SKILL.md](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/p-image/skills/p-image/SKILL.md) | [p-image-quality-checklist.md](https://github.com/PrunaAI/pruna-skills/tree/main/image/p-image-quality-checklist.md) |
| `p-image-try-on` | [p-image-try-on SKILL.md](../SKILL.md) | [p-image-try-on-quality-checklist.md](https://github.com/PrunaAI/pruna-skills/tree/main/image/p-image-try-on-quality-checklist.md) |
| `p-video-avatar` | [p-video-avatar SKILL.md](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/p-video-avatar/skills/p-video-avatar/SKILL.md) | [p-video-avatar-quality-checklist.md](https://github.com/PrunaAI/pruna-skills/tree/main/video/p-video-avatar-quality-checklist.md) |
