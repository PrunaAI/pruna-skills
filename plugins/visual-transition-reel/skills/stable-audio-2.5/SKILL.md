...
| Pruna-native audio | No — use [`p-video`](../p-video/SKILL.md) audio input instead |
...
- [visual-transition-reel](../visual-transition-reel/SKILL.md) — concat + optional bed assembly
