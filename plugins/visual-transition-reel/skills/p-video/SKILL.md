...
If the request exceeds one clip, **stop** and recommend: [image-to-video](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/image-to-video/skills/image-to-video/SKILL.md) (one narrated beat), [visual-transition-reel](../visual-transition-reel/SKILL.md) (multi-scene visual), or [narrated-multi-scene](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/narrated-multi-scene/skills/narrated-multi-scene/SKILL.md) (multi-scene + VO).
...
- Visual transitions (pair, multi-scene): [visual-transition-reel](../visual-transition-reel/SKILL.md)
