...
Related: [scene-anchor-triple.md](./scene-anchor-triple.md) (pair + audio) · [p-video](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/p-video/skills/p-video/SKILL.md) · [p-image](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/p-image/skills/p-image/SKILL.md) · [p-image-edit](../SKILL.md)
...
| **Start** | Hero + [`p-image-edit`](../SKILL.md) `edit_prompt` | `edit_prompt` |
...
- [p-video](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/p-video/skills/p-video/SKILL.md) — API reference (visual transition mode)
