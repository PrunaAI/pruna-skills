...
Related: [scene-anchor-triple.md](./scene-anchor-triple.md) (pair + audio) · [p-video](../SKILL.md) · [p-image](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/p-image/skills/p-image/SKILL.md) · [p-image-edit](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/p-image-edit/skills/p-image-edit/SKILL.md)
...
|-------|--------|------------|
| **Hero** (optional) | [`p-image`](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/p-image/skills/p-image/SKILL.md) text prompt | `hero_prompt` |
| **Start** | Hero + [`p-image-edit`](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/p-image-edit/skills/p-image-edit/SKILL.md) `edit_prompt` | `edit_prompt` |
...
4. **Optional bed** — [stable-audio-2.5](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/stable-audio-2.5/skills/stable-audio-2.5/SKILL.md) mixed under native SFX (~0.08–0.15 volume)

## Pair vs triple

| Pattern | Anchors | Duration | Workflow |
|---------|---------|----------|----------|
| **Pair** | `image` + `last_frame_image` + `prompt` | `duration` | [visual-transition-reel](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/visual-transition-reel/skills/visual-transition-reel/SKILL.md) |
...
- [visual-transition-reel](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/visual-transition-reel/skills/visual-transition-reel/SKILL.md) — primary workflow
...
- [p-video](../SKILL.md) — API reference (visual transition mode)
