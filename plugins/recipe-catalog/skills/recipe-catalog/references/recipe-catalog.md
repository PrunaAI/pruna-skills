...
Full intake and steps for each recipe in [pruna-generative-pipeline](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/pruna-generative-pipeline/skills/pruna-generative-pipeline/SKILL.md). **Confirm plan before any `POST /v1/predictions`.** Staged gates: [staged-generation-gate.md](https://github.com/PrunaAI/pruna-skills/tree/main/shared/staged-generation-gate.md).

## Recipe A — Style-locked mood board (same-style stills)

**Shine:** One style bible + repeated aspect ratio + [random seed ritual](https://github.com/PrunaAI/pruna-skills/tree/main/shared/random-seed-ritual.md) (SSoT) makes a grid feel art-directed, not random.
...
**Refs:** [p-image](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/p-image/skills/p-image/SKILL.md), [p-image-edit](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/p-image-edit/skills/p-image-edit/SKILL.md), [p-image-upscale](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/p-image-upscale/skills/p-image-upscale/SKILL.md)
...
3. **`p-video`** with `image` + motion `prompt`; add `last_frame_image` for controlled arc. Full intake: [image-to-video](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/image-to-video/skills/image-to-video/SKILL.md).

## Recipe E — Audio-conditioned `p-video` (single anchor)

**Shine:** Duration tracks audio automatically—ideal for VO-first social cuts.

**Intake:** Audio format? Visual story matching beats? Source: upload, [Gemini TTS](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/gemini-3.1-flash-tts/skills/gemini-3.1-flash-tts/SKILL.md), or [Music 2.5](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/music-2.5/skills/music-2.5/SKILL.md)?
...
For **full narrated story films**, use Recipe **P** ([scene anchor triple](https://github.com/PrunaAI/pruna-skills/tree/main/video/scene-anchor-triple.md)) instead.
...
1. Build **character sheet** and **scene table** — see [avatar-multi-scene](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/avatar-multi-scene/skills/avatar-multi-scene/SKILL.md).
2. Hero: **`p-image`** (photoreal, [SSoT ritual](https://github.com/PrunaAI/pruna-skills/tree/main/shared/random-seed-ritual.md)) → slop gate; lock plate URL.
3. Per scene: **`p-image-edit`** → slop gate — **parallel across scenes** after hero anchor is approved.
4. Hand off to [avatar-single-scene](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/avatar-single-scene/skills/avatar-single-scene/SKILL.md) or [avatar-multi-scene](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/avatar-multi-scene/skills/avatar-multi-scene/SKILL.md) for **`p-video-avatar`** batch.
...
1. Use [avatar-multi-scene](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/avatar-multi-scene/skills/avatar-multi-scene/SKILL.md) for all-`p-video-avatar` stacks, or mix with [narrated-multi-scene](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/narrated-multi-scene/skills/narrated-multi-scene/SKILL.md) B-roll only when the user explicitly wants cutaways.
...
1. Full workflow: [avatar-multi-scene](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/avatar-multi-scene/skills/avatar-multi-scene/SKILL.md) — **`animate`** rows, sliders, concat.
2. Optional **`p-image-edit`** to repose each still toward its motion keyframe before animate.
3. Slider renders via [`generate_video_comparison.py`](https://github.com/PrunaAI/pruna-skills/tree/main/workflows/_shared/scripts/generate_video_comparison.py).
...
1. Full workflow: [p-video-replace](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/p-video-replace/skills/p-video-replace/SKILL.md) + [visual-variety-bible.md](https://github.com/PrunaAI/pruna-skills/tree/main/shared/visual-variety-bible.md#prompt-patterns) — sliders via [`generate_video_comparison.py`](https://github.com/PrunaAI/pruna-skills/tree/main/workflows/_shared/scripts/generate_video_comparison.py).
...
**Steps:** [music-video](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/music-video/skills/music-video/SKILL.md) — lyrics → Music 2.5 → align → stills → `p-video-avatar` / `p-video` → assembly.
...
1. Full workflow: [narrated-multi-scene](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/narrated-multi-scene/skills/narrated-multi-scene/SKILL.md) — [scene-anchor-triple.md](https://github.com/PrunaAI/pruna-skills/tree/main/video/scene-anchor-triple.md).
2. Hero → parallel **`p-image-edit`** start + end stills → parallel Gemini TTS → probe each MP3 (≤ ~19s) → parallel **`p-video`** triple payloads.
3. Concat embedded VO → optional bed — [audio-post-production.md](https://github.com/PrunaAI/pruna-skills/tree/main/audio/audio-post-production.md).

## Recipe Q — Visual transition reel

**Shine:** Multi-scene motion between two stills per beat (no VO).

**Steps:** [visual-transition-reel](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/visual-transition-reel/skills/visual-transition-reel/SKILL.md) — [scene-anchor-pair.md](https://github.com/PrunaAI/pruna-skills/tree/main/video/scene-anchor-pair.md).

## Recipe R — Educational explainer

**Shine:** Narrator VO + expert/character dialogue.

**Steps:** [interactive-explainer](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/interactive-explainer/skills/interactive-explainer/SKILL.md) — narrator triple + character avatar → concat ± bed. Scenes: [interactive-explainer-scenes.md](https://github.com/PrunaAI/pruna-skills/tree/main/workflows/core/interactive-explainer-scenes/SKILL.md). Prompts: [interactive-explainer-prompts.md](https://github.com/PrunaAI/pruna-skills/tree/main/workflows/core/interactive-explainer-prompts/SKILL.md).
...
**Steps:** [illustrated-story-reel](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/illustrated-story-reel/skills/illustrated-story-reel/SKILL.md) — `p-image` hero → `p-image-edit` beats → Gemini TTS per beat **or** Stable Audio / user track → ffmpeg assemble.
...
**Intake:** Which verticals? Motion mix (avatar vs I2V vs slider)? Cast diversity per [visual-variety-bible.md](https://github.com/PrunaAI/pruna-skills/tree/main/shared/visual-variety-bible.md)?

**Steps:** [p-image-try-on](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/p-image-try-on/skills/p-image-try-on/SKILL.md) + [realistic-persona-showcase.md](https://github.com/PrunaAI/pruna-skills/tree/main/shared/realistic-persona-showcase.md) + [p-video-avatar](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/p-video-avatar/skills/p-video-avatar/SKILL.md) — phased gates per [workflow-feedback-gates.md](https://github.com/PrunaAI/pruna-skills/tree/main/workflows/core/workflow-feedback-gates/SKILL.md).
...
| Full SKU creative kit | **B** + [p-image-try-on](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/p-image-try-on/skills/p-image-try-on/SKILL.md) |
| Episodic mascot channel | **G** + [avatar-multi-scene](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/avatar-multi-scene/skills/avatar-multi-scene/SKILL.md) |
...
- Hub skill: [pruna-generative-pipeline/SKILL.md](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/pruna-generative-pipeline/skills/pruna-generative-pipeline/SKILL.md)
- Feedback discipline: [requesting-generation-feedback/SKILL.md](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/requesting-generation-feedback/skills/requesting-generation-feedback/SKILL.md)
- API: [pruna-api.md](https://github.com/PrunaAI/pruna-skills/tree/main/shared/pruna-api.md)
