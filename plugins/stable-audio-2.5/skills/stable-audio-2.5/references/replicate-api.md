...
Use for high-quality fast photoreal stills. Fastest drafts: [p-image](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/p-image/skills/p-image/SKILL.md) (Pruna P-API). Tool skill: [p-image-ideogram](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/p-image-ideogram/skills/p-image-ideogram/SKILL.md)
