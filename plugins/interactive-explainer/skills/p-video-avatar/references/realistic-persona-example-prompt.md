...
Use as **`person_image`** for complex suit try-on — see [p-image-try-on-quality-checklist.md](https://github.com/PrunaAI/pruna-skills/tree/main/references/shared/p-image-try-on-quality-checklist.md).
