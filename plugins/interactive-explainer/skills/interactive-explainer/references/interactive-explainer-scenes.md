...
Related: [scene-anchor-triple.md](https://github.com/PrunaAI/pruna-skills/tree/main/video/scene-anchor-triple.md) (narrator beats) · [avatar-multi-scene](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/avatar-multi-scene/skills/avatar-multi-scene/SKILL.md) (character beats) · [interactive-explainer](../SKILL.md)
...
| Narrator line length | **≤ ~19s** TTS (P-API 20s **audio-led `p-video`** cap) — see [scene-anchor-triple.md](https://github.com/PrunaAI/pruna-skills/tree/main/video/scene-anchor-triple.md) |
...
Scene anchor **triple** — same as [scene-anchor-triple.md](https://github.com/PrunaAI/pruna-skills/tree/main/video/scene-anchor-triple.md):
...
- [interactive-explainer](../SKILL.md) — primary workflow
- [narrated-multi-scene](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/narrated-multi-scene/skills/narrated-multi-scene/SKILL.md) — narrator-only fallback
- [avatar-multi-scene](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/avatar-multi-scene/skills/avatar-multi-scene/SKILL.md) — character-only pieces
