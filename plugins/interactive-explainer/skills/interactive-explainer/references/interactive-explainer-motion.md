...
Motion rules for **narrator** (`p-video`) and **character** (`p-video-avatar`) beats in [interactive-explainer](../SKILL.md).

Related: [scene-anchor-triple.md](./scene-anchor-triple.md) · [visual-transition-reel](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/visual-transition-reel/skills/visual-transition-reel/SKILL.md)
