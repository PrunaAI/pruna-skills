...
Do **not** use `npx plugins add PrunaAI/pruna-skills@narrated-multi-scene` — the plugins CLI has no `@name` filter (that’s skills only) and prints “No plugins found”.
