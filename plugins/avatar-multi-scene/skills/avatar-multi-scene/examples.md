...
3. Parallel **`p-video-animate`** → batch slider render via [`batch.template.json`](https://github.com/PrunaAI/pruna-skills/tree/main/mine/examples/workflows/launches/p-video-animate-comparison/batch.template.json).
