...
Animate slider reels: [`generate_video_comparison.py`](https://github.com/PrunaAI/pruna-skills/tree/main/workflows/_shared/scripts/generate_video_comparison.py) + [avatar-multi-scene](../avatar-multi-scene/SKILL.md) `animate` rows.
