...
Workflow skills: [avatar-single-scene](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/avatar-single-scene/skills/avatar-single-scene/SKILL.md) · [avatar-multi-scene](../../avatar-multi-scene/SKILL.md).
