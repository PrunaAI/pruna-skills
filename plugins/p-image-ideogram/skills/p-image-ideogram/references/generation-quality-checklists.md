...
| `p-image-ideogram` | [`p-image-quality-checklist.md`](https://github.com/PrunaAI/pruna-skills/tree/main/image/p-image-quality-checklist.md) · persona bar: [`realistic-persona-showcase.md`](./realistic-persona-showcase.md) | [`p-image-ideogram`](../SKILL.md), [`pruna-generative-pipeline`](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/pruna-generative-pipeline/skills/pruna-generative-pipeline/SKILL.md) |
