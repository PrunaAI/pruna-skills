...
More plate examples (including try-on garment tiers): [p-image-try-on SKILL.md](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/p-image-try-on/skills/p-image-try-on/SKILL.md#production-quality-not-basic-demos).
