...
**Before every job:** [random seed ritual](./references/random-seed-ritual.md) · [explicit prompt structure](./references/generation-diversity.md#explicit-prompt-structure-required) · [text rules by model](./references/generation-diversity.md#text--typography-by-model).
...
Photoreal persona bar: [realistic-persona-showcase.md](./references/realistic-persona-showcase.md).
...
Fastest drafts, mood boards, bulk panels with no dense typography → [p-image](https://github.com/PrunaAI/pruna-skills/tree/main/plugins/p-image/skills/p-image/SKILL.md) (Pruna P-API; no prompt upsampling).
