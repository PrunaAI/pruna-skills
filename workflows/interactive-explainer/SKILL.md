...
**Staged generation:** [staged-generation-gate.md](../references/policies/staged-generation-gate.md) — approve plan → stills → narration TTS → video clips → assembly + bed. Default runner phase is **`stills`**.

## Quick reference

| Resource | Path |
|----------|------|
| Positive prompts / blocked phrases | [interactive-explainer-prompts.md](../../../../../references/workflows/interactive-explainer-prompts.md) |
| Scene patterns & stand-alone test | [interactive-explainer-scenes.md](../../../../../references/workflows/interactive-explainer-scenes.md) |
| Motion (OPEN/MID/CLOSE) | [interactive-explainer-motion.md](../../../../../references/workflows/interactive-explainer-motion.md) |
...
Ask when art direction is unclear (visual mode, cast continuity, narrator vs character mix, bed yes/no) — see [staged-generation-gate.md](../references/policies/staged-generation-gate.md).
...
Dialogue arc, stand-alone test, causal chain, visual–audio alignment, visual modes, and three-beat ending: **[interactive-explainer-scenes.md](../../../../../references/workflows/interactive-explainer-scenes.md)**.
...
- Still-prompt **blocked substrings** — see [interactive-explainer-prompts.md](../../../../../references/workflows/interactive-explainer-prompts.md)
...
Default **`--phase stills`**. Phased commands: [workflow-feedback-gates.md](../../../../../references/workflows/workflow-feedback-gates.md) **Interactive explainer**.
...
- Feedback: [requesting-generation-feedback](../../router/references/policies/approval-red-flags.md)
