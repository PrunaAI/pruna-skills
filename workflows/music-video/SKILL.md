...
**Staged generation:** [staged-generation-gate.md](../references/policies/staged-generation-gate.md) — approve lyrics and stills before paid video jobs.
...
| **C — Stills** | `p-image` / `p-image-edit` | low | Per [staged-generation-gate.md](../references/policies/staged-generation-gate.md) |
...
1. Generate and gate **one hero** performance still with **`p-image`** + [random seed ritual](references/policies/random-seed-ritual.md) (SSoT); lock hero plate URL for continuity.
...
- **Slight angle from the side** — not “facing camera” in still prompts ([visual-variety-bible.md](references/policies/visual-variety-bible.md#prompt-patterns) blocked still phrases)
...
**Parallelize** independent clips after confirmation — [parallel-execution.md](../references/policies/parallel-execution.md).
...
| **Variety** | [visual-variety-bible.md](../references/policies/visual-variety-bible.md) — distinct world per B-roll insert |
