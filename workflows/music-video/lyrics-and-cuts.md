...
**B-roll prompts:** match **mood + palette** of the music prompt — golden hour for warm ballads, neon for electronic, etc. See [visual-variety-bible.md](../references/policies/visual-variety-bible.md).
...
- One grey-wall performance clip for every line — rotate settings per [visual-variety-bible.md](../references/policies/visual-variety-bible.md).
