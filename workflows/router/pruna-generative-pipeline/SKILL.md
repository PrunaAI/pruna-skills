...
- **Photoreal stills:** Hero via **`p-image-ideogram`** (high-quality fast) or **`p-image`** (fastest drafts) with documentary/photoreal prompt → slop gate; every **`p-image-edit`** still → slop gate before **`p-video-avatar`**. Persona bar: [realistic-persona-showcase.md](../../../../references/shared/realistic-persona-showcase.md).
