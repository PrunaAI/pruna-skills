...
See [scene-transition-video](../../../workflows/core/visual-transition-reel/SKILL.md) for multi-scene visual montages and [multi-scene-ai-video](../../../workflows/core/narrated-multi-scene/SKILL.md) for scene-table columns and [parallel-execution.md](./references/parallel-execution.md) for phased vs parallel batches.
...
**Audio phase:** [Gemini TTS](../../audio/gemini-3.1-flash-tts/SKILL.md) per scene (parallel) → upload each.  
