...
TTS per beat must be **≤ ~19s** (P-API audio-led cap ~20s). Probe before render — see [audio-in-video-prompting.md](../video/audio-in-video-prompting.md).
...
Rules (full ref: [audio-in-video-prompting.md](../video/audio-in-video-prompting.md)):
