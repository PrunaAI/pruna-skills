...
After each `p-video` output is saved, **open the clip and review it visually** against this checklist (agent vision review — see [generation-quality-checklists.md](../shared/generation-quality-checklists.md#who-applies-these-checklists)).
