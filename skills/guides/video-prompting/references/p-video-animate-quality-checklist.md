...
After each animate job, **open the source video, reference image, and output clip** and review them against this list (agent vision review — see [generation-quality-checklists.md](./generation-quality-checklists.md#who-applies-these-checklists)).
