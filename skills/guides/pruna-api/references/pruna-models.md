...
| `gemini-3.1-flash-tts` | Narration / voiceover TTS | `gemini-3.1-flash-tts` | Requires `REPLICATE_API_TOKEN`; mux or drive `p-video-2` via uploaded audio — `audio-prompting` |
