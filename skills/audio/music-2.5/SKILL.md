...
Full craft: [music-and-bed-prompting.md](../../../references/audio/music-and-bed-prompting.md). Follow the model’s [prompt guide](https://replicate.com/minimax/music-2.5): genre + mood + vocal description + tempo + instruments + production feel.
