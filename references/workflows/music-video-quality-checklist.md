...
- [ ] No readable UI text, laptops screens, or collage trigger words — see [p-video-replace-comparison SKILL](../guides/workflows/launches/p-video-replace-comparison/SKILL.md) still triggers where applicable
...
- [ai-music-video SKILL](../guides/workflows/verticals/music-video/SKILL.md)
- [lyrics-and-cuts.md](../guides/workflows/verticals/music-video/lyrics-and-cuts.md)
