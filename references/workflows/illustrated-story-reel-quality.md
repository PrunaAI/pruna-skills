...
- **[Generation diversity](../shared/generation-diversity.md)** — ritual seed + rotate scenario axes.
- **[Random seed ritual](../shared/random-seed-ritual.md)** — state ritual string before every prediction; never copy doc examples.
