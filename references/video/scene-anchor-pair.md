...
Related: [scene-anchor-triple.md](./scene-anchor-triple.md) (pair + audio) · [p-video](../tools/video/p-video/SKILL.md) · [p-image](../tools/image/p-image/SKILL.md) · [p-image-edit](../tools/image/p-image-edit/SKILL.md)
...
|-------|--------|------------|
| **Hero** (optional) | [`p-image`](../tools/image/p-image/SKILL.md) text prompt | `hero_prompt` |
| **Start** | Hero + [`p-image-edit`](../tools/image/p-image-edit/SKILL.md) `edit_prompt` | `edit_prompt` |
...
Helper: [`p_video_payload.py`](../guides/workflows/_shared/scripts/p_video_payload.py) — pass `duration`, omit `audio`.
...
1. **Concat** clips in scene order via [`concat_clips.py`](../guides/workflows/_shared/scripts/concat_clips.py)
...
4. **Optional bed** — [stable-audio-2.5](../tools/audio/stable-audio-2.5/SKILL.md) mixed under native SFX (~0.08–0.15 volume)

## Pair vs triple

| Pattern | Anchors | Duration | Workflow |
|---------|---------|----------|----------|
| **Pair** | `image` + `last_frame_image` + `prompt` | `duration` | [scene-transition-video](../guides/workflows/core/visual-transition-reel/SKILL.md) |
| **Triple** | pair + `audio` | follows audio | [multi-scene-ai-video](../guides/workflows/core/narrated-multi-scene/SKILL.md) |
...
- [scene-transition-video](../guides/workflows/core/visual-transition-reel/SKILL.md) — primary workflow
- [single-scene-ai-video](../guides/workflows/core/image-to-video/SKILL.md) — one pair beat
- [p-video](../tools/video/p-video/SKILL.md) — API reference (visual transition mode)
- Example runner: [`run_from_plan.py`](../guides/workflows/core/visual-transition-reel/scripts/run_from_plan.py)
