...
Helper: [`p_video_payload.py`](../workflows/_shared/scripts/p_video_payload.py) — pass `duration`, omit `audio`.
...
1. **Concat** clips in scene order via [`concat_clips.py`](../workflows/_shared/scripts/concat_clips.py)
