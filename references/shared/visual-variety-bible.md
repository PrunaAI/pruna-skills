...
See [p-video-replace-comparison/SKILL.md](../guides/workflows/launches/p-video-replace-comparison/SKILL.md) **Dynamic eye-catching prompts** and **Prompt trigger words** — flash without text/collage artifacts.
...
**Never use prompt trigger words** that cause stray text or multi-panel collages — see [p-video-replace-comparison/SKILL.md](../guides/workflows/launches/p-video-replace-comparison/SKILL.md) trigger tables. Prefer positive single-frame wording only.
...
| [pruna-generative-pipeline](../guides/workflows/router/pruna-generative-pipeline/SKILL.md) | Intake must capture variety plan before recipe execution |
