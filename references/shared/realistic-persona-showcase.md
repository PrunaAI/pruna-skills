...
**Variety ladders (full tables):** [visual-variety-bible.md](./visual-variety-bible.md) · **Try-on garment specifics:** [p-image-try-on-showcase.md](../image/p-image-try-on-showcase.md) · **Copy-paste examples:** [example-prompt.md](../../examples/shared/realistic-persona/example-prompt.md)
...
See [visual-variety-bible.md](./visual-variety-bible.md#prompt-patterns) and [p-video-replace-comparison SKILL.md](../../guides/workflows/launches/p-video-replace-comparison/SKILL.md) trigger tables.
...
More plate examples (including try-on reference tiers): [p-image-try-on-showcase.md](../image/p-image-try-on-showcase.md#example-person-plates-by-showcase-tier).
...
Templates: [prompt-templates.md](../../guides/workflows/core/avatar-multi-scene/prompt-templates.md).
...
Workflow skills: [avatar-single-scene](../../guides/workflows/core/avatar-single-scene/SKILL.md) · [avatar-multi-scene](../../guides/workflows/core/avatar-multi-scene/SKILL.md).
...
When stills risk signage or label bleed, use plan defaults — see [p-video-avatar SKILL.md](../../tools/video/p-video-avatar/SKILL.md#negative-prompt-suppress-on-screen-text). Primary fix remains **clean still prompts**; API negative prompt is a safety net.
...
Canonical try-on reference outputs (June 2026): [p-image-try-on-showcase.md](../image/p-image-try-on-showcase.md#reference-outputs-canonical-playground-bar).
...
|-------|-------|-----------|
| `p-image` | [p-image SKILL.md](../../tools/image/p-image/SKILL.md) | [p-image-quality-checklist.md](../image/p-image-quality-checklist.md) |
