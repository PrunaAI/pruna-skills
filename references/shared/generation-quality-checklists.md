...
|------------|-----------|---------------|
| `p-image` | [`p-image-quality-checklist.md`](../image/p-image-quality-checklist.md) · persona bar: [`realistic-persona-showcase.md`](./realistic-persona-showcase.md) | [`image-to-video`](../workflows/core/image-to-video/SKILL.md), [`narrated-multi-scene`](../workflows/core/narrated-multi-scene/SKILL.md), [`pruna-generative-pipeline`](../workflows/router/pruna-generative-pipeline/SKILL.md) |
| `p-image-ideogram` | [`p-image-quality-checklist.md`](../image/p-image-quality-checklist.md) · persona bar: [`realistic-persona-showcase.md`](./realistic-persona-showcase.md) | [`p-image-ideogram`](../tools/image/p-image-ideogram/SKILL.md), [`pruna-generative-pipeline`](../workflows/router/pruna-generative-pipeline/SKILL.md) |
| `p-image-edit` | [`p-image-edit-quality-checklist.md`](../image/p-image-edit-quality-checklist.md) | [`avatar-single-scene`](../workflows/core/avatar-single-scene/SKILL.md), [`avatar-multi-scene`](../workflows/core/avatar-multi-scene/SKILL.md), [`pruna-generative-pipeline`](../workflows/router/pruna-generative-pipeline/SKILL.md) |
| `p-image-upscale` | [`p-image-upscale-quality-checklist.md`](../image/p-image-upscale-quality-checklist.md) | [`image-to-video`](../workflows/core/image-to-video/SKILL.md), [`narrated-multi-scene`](../workflows/core/narrated-multi-scene/SKILL.md), [`pruna-generative-pipeline`](../workflows/router/pruna-generative-pipeline/SKILL.md), [`generate_upscale_comparison.py`](../workflows/_shared/scripts/generate_upscale_comparison.py) |
| `p-image-try-on` | [`p-image-try-on-quality-checklist.md`](../image/p-image-try-on-quality-checklist.md) | [`pruna-generative-pipeline`](../workflows/router/pruna-generative-pipeline/SKILL.md), [`p-image-try-on`](../tools/image/p-image-try-on/SKILL.md), [`realistic-persona-showcase.md`](./realistic-persona-showcase.md) |
| `p-video` | [`p-video-quality-checklist.md`](../video/p-video-quality-checklist.md) | [`image-to-video`](../workflows/core/image-to-video/SKILL.md), [`narrated-multi-scene`](../workflows/core/narrated-multi-scene/SKILL.md), [`interactive-explainer`](../workflows/verticals/interactive-explainer/SKILL.md), [`visual-transition-reel`](../workflows/core/visual-transition-reel/SKILL.md), [`pruna-generative-pipeline`](../workflows/router/pruna-generative-pipeline/SKILL.md) |
| `p-video-avatar` | [`p-video-avatar-quality-checklist.md`](../video/p-video-avatar-quality-checklist.md) · persona bar: [`realistic-persona-showcase.md`](./realistic-persona-showcase.md) | [`avatar-single-scene`](../workflows/core/avatar-single-scene/SKILL.md), [`avatar-multi-scene`](../workflows/core/avatar-multi-scene/SKILL.md), [`interactive-explainer`](../workflows/verticals/interactive-explainer/SKILL.md), [`pruna-generative-pipeline`](../workflows/router/pruna-generative-pipeline/SKILL.md) |
| `p-video-animate` | [`p-video-animate-quality-checklist.md`](../video/p-video-animate-quality-checklist.md) | [`avatar-multi-scene`](../workflows/core/avatar-multi-scene/SKILL.md), [`pruna-generative-pipeline`](../workflows/router/pruna-generative-pipeline/SKILL.md) |
| `p-video-replace` | [`p-video-replace-quality-checklist.md`](../video/p-video-replace-quality-checklist.md) | [`p-video-replace`](../tools/video/p-video-replace/SKILL.md), [`generate_video_comparison.py`](../workflows/_shared/scripts/generate_video_comparison.py) |
| `music-2.5` + music video assembly | [`music-video-quality-checklist.md`](../workflows/music-video-quality-checklist.md) | [`music-video`](../workflows/verticals/music-video/SKILL.md), [`music-2.5`](../tools/audio/music-2.5/SKILL.md) |
