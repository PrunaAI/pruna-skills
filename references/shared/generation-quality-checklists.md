...
| `p-image-try-on` | [`p-image-try-on-quality-checklist.md`](../image/p-image-try-on-quality-checklist.md) · showcase: [`p-image-try-on-showcase.md`](../image/p-image-try-on-showcase.md) | [`pruna-generative-pipeline`](../guides/workflows/router/pruna-generative-pipeline/SKILL.md) (ecommerce / catalog recipes), [`p-image-try-on-launch`](../guides/workflows/launches/p-image-try-on-launch/SKILL.md) |
