...
|------------|-----------|---------------|
| `p-image` | [`p-image-quality-checklist.md`](../image/p-image-quality-checklist.md) · persona bar: [`realistic-persona-showcase.md`](./realistic-persona-showcase.md) | [`single-scene-ai-video`](../workflows/core/image-to-video/SKILL.md), [`multi-scene-ai-video`](../workflows/core/narrated-multi-scene/SKILL.md), [`pruna-generative-pipeline`](../workflows/router/pruna-generative-pipeline/SKILL.md) |
| `p-image-edit` | [`p-image-edit-quality-checklist.md`](../image/p-image-edit-quality-checklist.md) | [`single-scene-avatar-video`](../workflows/core/avatar-single-scene/SKILL.md), [`multi-scene-avatar-video`](../workflows/core/avatar-multi-scene/SKILL.md), [`pruna-generative-pipeline`](../workflows/router/pruna-generative-pipeline/SKILL.md) |
...
| `p-video` | [`p-video-quality-checklist.md`](../video/p-video-quality-checklist.md) | [`single-scene-ai-video`](../workflows/core/image-to-video/SKILL.md), [`multi-scene-ai-video`](../workflows/core/narrated-multi-scene/SKILL.md), [`educational-explainer`](../workflows/verticals/interactive-explainer/SKILL.md), [`scene-transition-video`](../workflows/core/visual-transition-reel/SKILL.md), [`pruna-generative-pipeline`](../workflows/router/pruna-generative-pipeline/SKILL.md) |
| `p-video-avatar` | [`p-video-avatar-quality-checklist.md`](../video/p-video-avatar-quality-checklist.md) · persona bar: [`realistic-persona-showcase.md`](./realistic-persona-showcase.md) | [`single-scene-avatar-video`](../workflows/core/avatar-single-scene/SKILL.md), [`multi-scene-avatar-video`](../workflows/core/avatar-multi-scene/SKILL.md), [`educational-explainer`](../workflows/verticals/interactive-explainer/SKILL.md), [`pruna-generative-pipeline`](../workflows/router/pruna-generative-pipeline/SKILL.md) |
| `p-video-animate` | [`p-video-animate-quality-checklist.md`](../video/p-video-animate-quality-checklist.md) | [`multi-scene-avatar-video`](../workflows/core/avatar-multi-scene/SKILL.md), [`pruna-generative-pipeline`](../workflows/router/pruna-generative-pipeline/SKILL.md) |
...
| `music-2.5` + music video assembly | [`music-video-quality-checklist.md`](../workflows/music-video-quality-checklist.md) | [`ai-music-video`](../workflows/verticals/music-video/SKILL.md), [`music-2.5`](../tools/audio/music-2.5/SKILL.md) |
