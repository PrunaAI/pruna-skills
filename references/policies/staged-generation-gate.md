...
For replace-slider plans, map partial regen to the table above; blocked still trigger words: [visual-variety-bible.md](../shared/visual-variety-bible.md#prompt-patterns).
