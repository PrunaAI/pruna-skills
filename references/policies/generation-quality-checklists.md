...
|------------|-----------|---------------|
| `p-image` | [`p-image-quality-checklist.md`](../image/p-image-quality-checklist.md) · persona bar: [`realistic-persona-showcase.md`](../shared/realistic-persona-showcase.md) | [`image-to-video`](../../workflows/image-to-video/SKILL.md), [`narrated-multi-scene`](../../workflows/narrated-multi-scene/SKILL.md), [`WORKFLOW-RECIPES`](../../docs/WORKFLOW-RECIPES.md) |
| `p-image-edit` | [`p-image-edit-quality-checklist.md`](../image/p-image-edit-quality-checklist.md) | [`avatar-single-scene`](../../workflows/avatar-single-scene/SKILL.md), [`avatar-multi-scene`](../../workflows/avatar-multi-scene/SKILL.md), [`WORKFLOW-RECIPES`](../../docs/WORKFLOW-RECIPES.md) |
| `p-image-upscale` | [`p-image-upscale-quality-checklist.md`](../image/p-image-upscale-quality-checklist.md) | [`image-to-video`](../../workflows/image-to-video/SKILL.md), [`narrated-multi-scene`](../../workflows/narrated-multi-scene/SKILL.md), [`WORKFLOW-RECIPES`](../../docs/WORKFLOW-RECIPES.md), [`generate_upscale_comparison.py`](../../workflows/_shared/scripts/generate_upscale_comparison.py) |
| `p-image-try-on` | [`p-image-try-on-quality-checklist.md`](../image/p-image-try-on-quality-checklist.md) | [`WORKFLOW-RECIPES`](../../docs/WORKFLOW-RECIPES.md), [`p-image-try-on`](../../tools/image/p-image-try-on/SKILL.md), [`realistic-persona-showcase.md`](../shared/realistic-persona-showcase.md) |
| `p-video` | [`p-video-quality-checklist.md`](../video/p-video-quality-checklist.md) | [`image-to-video`](../../workflows/image-to-video/SKILL.md), [`narrated-multi-scene`](../../workflows/narrated-multi-scene/SKILL.md), [`interactive-explainer`](../../workflows/interactive-explainer/SKILL.md), [`visual-transition-reel`](../../workflows/visual-transition-reel/SKILL.md), [`WORKFLOW-RECIPES`](../../docs/WORKFLOW-RECIPES.md) |
| `p-video-avatar` | [`p-video-avatar-quality-checklist.md`](../video/p-video-avatar-quality-checklist.md) · persona bar: [`realistic-persona-showcase.md`](../shared/realistic-persona-showcase.md) | [`avatar-single-scene`](../../workflows/avatar-single-scene/SKILL.md), [`avatar-multi-scene`](../../workflows/avatar-multi-scene/SKILL.md), [`interactive-explainer`](../../workflows/interactive-explainer/SKILL.md), [`WORKFLOW-RECIPES`](../../docs/WORKFLOW-RECIPES.md) |
| `p-video-animate` | [`p-video-animate-quality-checklist.md`](../video/p-video-animate-quality-checklist.md) | [`avatar-multi-scene`](../../workflows/avatar-multi-scene/SKILL.md), [`WORKFLOW-RECIPES`](../../docs/WORKFLOW-RECIPES.md) |
...
| `music-2.5` + music video assembly | [`music-video-quality-checklist.md`](../workflows/music-video-quality-checklist.md) | [`music-video`](../../workflows/music-video/SKILL.md), [`music-2.5`](../../tools/audio/music-2.5/SKILL.md) |
...
Before **any** generation, run [generation-diversity.md](./generation-diversity.md). Launch reels: also [visual-variety-bible.md](../shared/visual-variety-bible.md) **Variety checklist**. Persona/playground bar: [realistic-persona-showcase.md](../shared/realistic-persona-showcase.md).
