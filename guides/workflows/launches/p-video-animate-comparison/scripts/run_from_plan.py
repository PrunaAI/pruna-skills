...
Default phase is ``stills``. See references/shared/staged-generation-gate.md.
"""
...
_REPO = repo_root()
DEFAULT_PLAN = _REPO / "output/launches/p-video-animate-announcement/announcement_plan.json"
