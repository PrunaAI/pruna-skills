...
**Canonical workflow:** [multi-scene-avatar-video](../core/avatar-multi-scene/SKILL.md)

Covers **slider comparison renders** and how **`p-video-animate`** fits into mixed reels.

**Visual variety:** [visual-variety-bible.md](../../../references/shared/visual-variety-bible.md) — each animate slider row uses distinct **`visual_style_tag`** with unique backgrounds, camera angles, and lighting per persona still.
...
Default runner behavior is **`--phase stills`** — reference plates and motion sources only. Do not call `p-video-animate` until the user approves stills. See [staged-generation-gate.md](../../../references/shared/staged-generation-gate.md).
...
See [animate-beats.md](../core/avatar-multi-scene/animate-beats.md) for the full pipeline. Summary:
...
**Batch:** [`examples/workflows/launches/p-video-animate-comparison/batch.template.json`](../../../examples/workflows/launches/p-video-animate-comparison/batch.template.json)

## Example plan + runner

[`examples/workflows/launches/p-video-animate-comparison/example-prompt.md`](../../../examples/workflows/launches/p-video-animate-comparison/example-prompt.md)
...
| Mixed avatar + animate workflow | [multi-scene-avatar-video/SKILL.md](../core/avatar-multi-scene/SKILL.md) |
| Animate beat pipeline & alignment | [animate-beats.md](../core/avatar-multi-scene/animate-beats.md) |
...
| Prompt templates | [prompt-templates.md](../core/avatar-multi-scene/prompt-templates.md) |

## Install

```bash
cp -R guides/workflows/core/avatar-multi-scene ~/.cursor/skills/
```
