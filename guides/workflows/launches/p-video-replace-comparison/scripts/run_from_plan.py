...
Default phase is ``stills`` (Phase A only). See references/shared/staged-generation-gate.md.
"""
...
_REPO = repo_root()
DEFAULT_PLAN = _REPO / "output/launches/p-video-replace-announcement/announcement_plan.json"
