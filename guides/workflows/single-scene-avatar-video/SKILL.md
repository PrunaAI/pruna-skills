...
One approved portrait → one **`p-video-avatar`** job. Stills and QA reuse the same patterns as [multi-scene-avatar-video](../multi-scene-avatar-video/SKILL.md); use [generation-quality-checklists.md](../../../references/generation-quality-checklists.md) and that folder’s **`prompt-templates.md`**.
...
Atomic APIs: [p-video-avatar](../../../tools/video/p-video-avatar/SKILL.md), [p-image](../../../tools/image/p-image/SKILL.md), [p-image-edit](../../../tools/image/p-image-edit/SKILL.md), [references/pruna-api.md](../../../references/pruna-api.md).
...
- Multi-scene version: [multi-scene-avatar-video](../multi-scene-avatar-video/SKILL.md)
