...
Canonical skills-library reel: [`output/skills-library-announcement/announcement_plan.json`](../../../output/skills-library-announcement/announcement_plan.json) · [`manifest.md`](../../../output/skills-library-announcement/manifest.md).
...
[`example-prompt.md`](../../../examples/workflows/p-video-replace-comparison/example-prompt.md) · [`run_from_plan.py`](./scripts/run_from_plan.py)
