...
Plan: [`output/skills-library-announcement/announcement_plan.json`](../../../output/skills-library-announcement/announcement_plan.json) · outputs: [`output/skills-library-announcement/`](../../../output/skills-library-announcement/).
...
Legacy 8-scene product launch: [`output/p-video-replace-announcement/announcement_plan.json`](../../../output/p-video-replace-announcement/announcement_plan.json).
...
> **Legacy prop note:** closed **laptop** at chest appears in this 8-scene plan only. New showcase reels use **hardcover notebook**, **tumbler**, or **mug** — laptops/keyboards trigger UI text and failed swaps in production.
...
**Skills-library scene 2 pattern:** source = mirror boutique + split gel; refs = rooftop anime · clay elder · neon arcade — see [`announcement_plan.json`](../../../output/skills-library-announcement/announcement_plan.json).
...
rm -f output/skills-library-announcement/sources/scene05_*
rm -f output/skills-library-announcement/clips/05_*
rm -f output/skills-library-announcement/references/scene05_*.jpeg
rm -f output/skills-library-announcement/stills/scene05_source_plate.jpeg
...
**Skills-library voice arc (7 scenes):** one continuous story — each `voice_script` continues the previous thought. Full lines in [`announcement_plan.json`](../../../output/skills-library-announcement/announcement_plan.json).
