...
**Story depth bar (required before render):** The film must pass the [stand-alone test](../../../../../references/workflows/interactive-explainer-scenes.md#stand-alone-test). If the story is a biography, pick **one through-line** — not a life survey. Reference quality: `output/verticals/interactive-explainer/ancaster-explainer/plan.json`.
...
Full table: [p-video-replace-comparison/SKILL.md](../../launches/p-video-replace-comparison/SKILL.md) **Prompt trigger words**. The runner **errors** on common triggers before any API call.
...
- Example: [examples/workflows/verticals/interactive-explainer/example-prompt.md](../../../../examples/workflows/verticals/interactive-explainer/example-prompt.md)
- Gold-standard plan (history, witness dialogue): `output/verticals/interactive-explainer/ancaster-explainer/plan.json`
