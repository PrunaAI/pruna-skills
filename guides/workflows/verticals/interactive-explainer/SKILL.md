...
description: Use when the user wants educational explainers with a host plus in-story characters, history or science shorts, or witness/expert dialogue—not wall-to-wall narration alone.
metadata:
  version: "0.0.8"
---
