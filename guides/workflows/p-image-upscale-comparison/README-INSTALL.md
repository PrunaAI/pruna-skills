...
- `examples/workflows/p-image-upscale-comparison/scripts/generate_upscale_prompt_examples.py`
- `examples/workflows/p-image-upscale-comparison/scripts/render_prompt_example_videos.py`
- `examples/workflows/p-image-upscale-comparison/scripts/render_mp_tier_zoom_video.py`
- `examples/workflows/p-image-upscale-comparison/scripts/prepare_*_demo.py`
