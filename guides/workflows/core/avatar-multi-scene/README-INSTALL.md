...
cp -R /path/to/pruna-ai-content-generation-skills/guides/workflows/core/avatar-multi-scene ~/.cursor/skills/
```
...
- `references/shared/generation-quality-checklists.md` — shared gate for stills before avatar jobs.
