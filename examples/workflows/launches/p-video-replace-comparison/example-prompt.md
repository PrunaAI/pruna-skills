...
Use **[p-video-replace-comparison](../../../guides/workflows/launches/p-video-replace-comparison/SKILL.md)** with **`replace`** rows (hook/CTA are replace sliders with VO sources, not separate avatar-only clips). Pipeline: [replace-beats.md](../../../guides/workflows/launches/p-video-replace-comparison/replace-beats.md).
...
pip install -r guides/workflows/launches/p-video-replace-comparison/scripts/requirements.txt
...
Motion-transfer → [p-video-animate-comparison](../../../guides/workflows/launches/p-video-animate-comparison/SKILL.md).
