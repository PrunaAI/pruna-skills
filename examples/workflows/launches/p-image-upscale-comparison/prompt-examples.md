...
**Repo maintainer only** — not bundled in portable install. Scripts live under `examples/workflows/launches/p-image-upscale-comparison/scripts/`.
...
python3 examples/workflows/launches/p-image-upscale-comparison/scripts/generate_upscale_prompt_examples.py --skip-generate

# Custom tiers / subset
python3 examples/workflows/launches/p-image-upscale-comparison/scripts/generate_upscale_prompt_examples.py --targets 32,64,128 --limit 4
```

Output: `output/launches/p-image-upscale-comparison/prompt-examples/gallery.html`
...
```bash
python3 examples/workflows/launches/p-image-upscale-comparison/scripts/render_mp_tier_zoom_video.py --force
```
