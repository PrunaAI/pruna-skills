...
```bash
pip install -r guides/workflows/launches/p-image-upscale-comparison/scripts/requirements.txt
...
```bash
cp examples/workflows/launches/p-image-upscale-comparison/config.template.json output/my-demo.config.json
# edit paths + regions, then:

python3 guides/workflows/launches/p-image-upscale-comparison/scripts/generate_upscale_comparison.py --config output/my-demo.config.json
```
...
```bash
python3 guides/workflows/launches/p-image-upscale-comparison/scripts/generate_upscale_comparison.py \
  --config examples/workflows/launches/p-image-upscale-comparison/tellers-scene3.fixture.json
```
