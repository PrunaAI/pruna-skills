...
cp guides/workflows/verticals/music-video/templates/music-video-plan.template.json \
   output/verticals/music-video/my-music-video/music_video_plan.json
```

Edit `lyrics` and `music.prompt`, then follow [examples.md](../../../../guides/workflows/verticals/music-video/examples.md).
