...
**Before every job:** [random seed ritual](../../references/shared/random-seed-ritual.md).
...
Starter plates aligned with the [showcase bar](../../references/image/p-image-try-on-showcase.md) and [realistic-persona-showcase.md](../../references/shared/realistic-persona-showcase.md).
...
See [visual-variety-bible.md](../../references/shared/visual-variety-bible.md) for cast ledger fields.
