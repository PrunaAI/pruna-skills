...
**Before every curl:** [random seed ritual](../../../catalog/references/shared/random-seed-ritual.md) + [generation diversity](../../../catalog/references/shared/generation-diversity.md) — pick seed and a **different `aspect_ratio`** per example in a batch (`1:1`, `16:9`, `9:16`, `4:3`, `3:4`, `3:2`, `2:3`).

Full ladders and 8-slot matrix: [realistic-persona-showcase.md](../../../catalog/references/shared/realistic-persona-showcase.md).
...
Use as **`person_image`** for complex suit try-on — see [p-image-try-on-quality-checklist.md](../../catalog/references/image/p-image-try-on-quality-checklist.md).
...
Same **`seed`** as hero. Unique **`video_prompt`** per scene.
...
Full rules: [realistic-persona-showcase.md](../../../catalog/references/shared/realistic-persona-showcase.md) · [visual-variety-bible.md](../../../catalog/references/shared/visual-variety-bible.md).
