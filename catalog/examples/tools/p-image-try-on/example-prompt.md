...
**Before every job:** [random seed ritual](../../catalog/references/shared/random-seed-ritual.md).

Try-on scenario briefs and Replicate reference links. **Cross-model persona + avatar examples:** [examples/shared/realistic-persona/example-prompt.md](../shared/realistic-persona/example-prompt.md).

Starter plates aligned with [p-image-try-on-quality-checklist.md](../../catalog/references/image/p-image-try-on-quality-checklist.md) and [realistic-persona-showcase.md](../../catalog/references/shared/realistic-persona-showcase.md).
...
curl -X POST 'https://api.pruna.ai/v1/predictions' \
  ...
  -H 'Model: p-image' \
  -d '{"input":{"prompt":"Photoreal editorial fashion photograph, woman mid-20s South Asian, seated on weathered wood floor against textured plaster wall, soft window daylight, 3:4, natural skin, single subject one frame","aspect_ratio":"3:4","seed":RITUAL_SEED}}'

# Replace RITUAL_SEED with your random integer — see random-seed-ritual.md
...
Run the slop gate on the person plate before step 2. Run [p-image-try-on-quality-checklist.md](../../catalog/references/image/p-image-try-on-quality-checklist.md) on the output.
...
See [visual-variety-bible.md](../../catalog/references/shared/visual-variety-bible.md) for cast ledger fields.
