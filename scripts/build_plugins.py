...
def write_clawhub_package_files(
    ...
    (plugin_dir / "openclaw.plugin.json").write_text(json.dumps(openclaw, indent=2) + "\n")
    package = {
        ...
        "description": description,
        "repository": f"https://github.com/{GITHUB_REPO}",
        "files": [".claude-plugin", "openclaw.plugin.json", "skills"],
        "openclaw": {"bundledSkills": bundled_skills},
    }
