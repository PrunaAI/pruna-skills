...
| Skill | Description |
|-------|-------------|
| [p-video](https://github.com/PrunaAI/pruna-skills/tree/main/skills/video/p-video/SKILL.md) | Use when someone wants a simple short clip from text or images — quick B-roll, drafts, or start/end frame animation. Not when the brief needs cinematic generation, highest quality, tight lip-sync, or imported audio at 1080p. |
| [p-video-2](https://github.com/PrunaAI/pruna-skills/tree/main/skills/video/p-video-2/SKILL.md) | Use when someone wants a polished short clip from text, images, or imported audio — 1080p B-roll, start/end frame animation, or a motion shot with a mixed track. Not for cinematic generated-audio clips or talking-head-only hosts. |
| [p-video-2-pro](https://github.com/PrunaAI/pruna-skills/tree/main/skills/video/p-video-2-pro/SKILL.md) | Use when someone wants a cinematic clip from text or start/end frames — product ads, documentary shots, or dialogue with generated audio. Not for 1080p, imported audio tracks, or talking-head-only hosts. |
